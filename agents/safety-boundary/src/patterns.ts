 ...
 */
export const SAFETY_CATEGORIES: SafetyBoundaryCategory[] = [
  'harmful_content',
  'explicit_content',
  'hate_speech',
  'violence',
...
export function getPatternsForCategories(
  categories: SafetyBoundaryCategory[]
): SafetyPattern[] {
 ...
 * Get all patterns
 */
export function getAllPatterns(): SafetyPattern[] {
 ...
 * Get pattern by ID
 */
export function getPatternById(id: string): SafetyPattern | undefined {

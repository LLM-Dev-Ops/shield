...
export const SECRET_PATTERNS: DetectionPattern[] = [
  // AWS Access Key ID
  {
...
export const CREDENTIAL_PATTERNS: DetectionPattern[] = [
 ...
 */
export function getPatternsByCategory(category: 'pii' | 'secret' | 'credential'): DetectionPattern[] {
 ...
 */
export function getPatternsByType(type: string): DetectionPattern[] {

 ...
 */
export const MODEL_ABUSE_PATTERNS: ModelAbusePattern[] = [
  // Model Extraction Attempts
  {
 ...
 */
export const BEHAVIORAL_THRESHOLDS: BehavioralThreshold[] = [
  {
    id: 'rate-high',
    category: 'rate_limit_evasion',
 ...
 */
export function getThresholdsForCategories(
  categories: ModelAbuseCategory[]
): BehavioralThreshold[] {
 ...
 * Get pattern by ID
 */
export function getPatternById(id: string): ModelAbusePattern | undefined {
 ...
 * Get threshold by ID
 */
export function getThresholdById(id: string): BehavioralThreshold | undefined {

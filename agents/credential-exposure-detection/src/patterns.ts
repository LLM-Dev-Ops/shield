 ...
 */
export function getPairPatterns(): CredentialPattern[] {
 ...
 */
export function getPasswordOnlyPatterns(): CredentialPattern[] {
 ...
 */
export function getUsernameOnlyPatterns(): CredentialPattern[] {
 ...
 */
export function getAuthHeaderPatterns(): CredentialPattern[] {
  return CREDENTIAL_PATTERNS.filter(
    (p) =>
      p.category === 'basic_auth' ||
...
export function createCustomPattern(
  patternId: string,
  regexStr: string,
  category: CredentialType = 'generic_credential'

...
import type { ContentModerationDecisionEvent } from '@llm-shield/agentics-contracts';
...
export class RuVectorClient {
  ...
  async persistDecisionEvent(
    event: ContentModerationDecisionEvent
...
export function createMockRuVectorClient(): RuVectorClient {
  ...
  client.persistDecisionEvent = async (event: ContentModerationDecisionEvent) => ({
    success: true,

 ...
 */
export const MODERATION_CATEGORIES: ContentModerationCategory[] = [
  'adult_content',
  'violence_graphic',
  'hate_discriminatory',
  'harassment_bullying',
 ...
 */
export const MODERATION_PATTERNS: ModerationPattern[] = [
  // ============================================
 ...
 * Get all patterns
 */
export function getAllPatterns(): ModerationPattern[] {
 ...
 * Get pattern by ID
 */
export function getPatternById(id: string): ModerationPattern | undefined {
